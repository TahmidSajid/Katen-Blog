...
<body>
    <div class="container" style="padding-top: 100px">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="{{ route('post.update',$post) }}" class="mx-auto" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="blog_title"
                                    placeholder="Enter Your Blog Title" value="{{ $post->blog_title }}">
                                @error('blog_title')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <img style="height: 100px; width:100px;" src="{{ asset('uploads/blog_photos') }}/{{ $post->blog_photo }}" alt="">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <!-- Email input -->
                            <div class="form-group">
                                <select class="form-select form-control" name="category">
                                    ...
                                    @forelse (App\Models\Categories::all() as $category)
                                        <option value="{{ $category->id }}" @if($category->id == $post->blog_category) selected @endif>{{ $category->category_name }}
                                        </option>
                                    @empty
                        ...
                        <div class="column col-md-12">
                            <textarea name="blog" id="summernote" cols="30" rows="10">{{ $post->blog }}</textarea>
                            @error('blog')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
